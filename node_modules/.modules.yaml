...
hoistedDependencies:
  ...
  /@napi-rs/simple-git-android-arm-eabi/0.1.8:
    '@napi-rs/simple-git-android-arm-eabi': private
  /@napi-rs/simple-git-android-arm64/0.1.8:
    '@napi-rs/simple-git-android-arm64': private
  /@napi-rs/simple-git-darwin-arm64/0.1.8:
    '@napi-rs/simple-git-darwin-arm64': private
  /@napi-rs/simple-git-darwin-x64/0.1.8:
    '@napi-rs/simple-git-darwin-x64': private
  /@napi-rs/simple-git-linux-arm-gnueabihf/0.1.8:
    '@napi-rs/simple-git-linux-arm-gnueabihf': private
  /@napi-rs/simple-git-linux-arm64-gnu/0.1.8:
    '@napi-rs/simple-git-linux-arm64-gnu': private
  /@napi-rs/simple-git-linux-arm64-musl/0.1.8:
    '@napi-rs/simple-git-linux-arm64-musl': private
  /@napi-rs/simple-git-linux-x64-gnu/0.1.8:
    '@napi-rs/simple-git-linux-x64-gnu': private
  /@napi-rs/simple-git-linux-x64-musl/0.1.8:
    '@napi-rs/simple-git-linux-x64-musl': private
  /@napi-rs/simple-git-win32-arm64-msvc/0.1.8:
    '@napi-rs/simple-git-win32-arm64-msvc': private
  /@napi-rs/simple-git-win32-x64-msvc/0.1.8:
    '@napi-rs/simple-git-win32-x64-msvc': private
  /@napi-rs/simple-git/0.1.8:
    '@napi-rs/simple-git': private
  /@next/env/13.0.6:
    '@next/env': private
  ...
  /nanoid/3.3.4:
    nanoid: private
  /next-seo/5.15.0_6jx7hpii6hgsrmhxgqrmo3277u:
    next-seo: private
  ...
  /rehype-mdx-title/1.0.0:
    rehype-mdx-title: private
  /rehype-pretty-code/0.2.4_shiki@0.10.1:
    rehype-pretty-code: private
  /remark-gfm/3.0.1:
    remark-gfm: private
  /remark-mdx/2.1.5:
    remark-mdx: private
...
pendingBuilds: []
prunedAt: Thu, 08 Dec 2022 11:22:59 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped:
  ...
  - /@next/swc-win32-ia32-msvc/13.0.6
  - /@next/swc-win32-x64-msvc/13.0.6
storeDir: /home/ismoilovdev/.local/share/pnpm/store/v3
